export enum PackageErrorCode {
    ...
    CruxDomainInvalidStructure = 4018,
    CruxDomainNamespaceValidation = 4019,
    BlockstackDomainInvalidStructure = 4020,
    BlockstackDomainNamespaceValidation = 4021,
    // Internal errors
    ...
    MissingCruxAssetTranslator = 5010,
    MissingDomainContext = 5011,
    MissingAssetMapping = 5012,
    IsNotSupported = 5013,
    MissingCruxDomainInCruxWalletClient = 5014,
    CouldNotExtractGaiaDataFromZoneFile = 5015,
    MissingZoneFile = 5016,
    MissingNameOwnerAddress = 5017,
}
