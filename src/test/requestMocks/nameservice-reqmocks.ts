let requestResponseArray: { request: object, response: object }[] = [
  ...
  },
  {
    request:
    {
      method: 'GET',
      baseUrl: 'https://core.blockstack.org',
      url: '/v1/names/example.cruxdev.id',
      json: true
    },
    response:
    {
  ...
  },
  {
    request: {
      method: 'GET',
      baseUrl: 'https://cruxdev-registrar.cruxpay.com',
      url: '/status/cs1',
      json: true
    },
    response: {
