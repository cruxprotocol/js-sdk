...
class OpenPayPeer extends EventEmitter {
    ...
    constructor(_options: IOpenPayPeerOptions) {
        ...
        this._assetList = JSON.parse(fs.readFileSync(__dirname + "../config/asset-list.json", "utf-8"));
        let allClientMapping = JSON.parse(fs.readFileSync(__dirname + "../config/client-mapping.json", "utf-8"));
